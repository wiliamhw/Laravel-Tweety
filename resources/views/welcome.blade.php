<x-landing>
    ...
    <div class="w-5/6 my-10 ml-6">
        <h3 class="absolute text-gray-300 z-10">
            ...
            <br /><a class="underline" href="https://github.com/wiliamhw" target="_blank">See Github</a>
        </h3>
    </div>
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
            ...
            <a href="https://tailwindcss.com/" target="_blank" rel="noopener">
                <div
                    ...
                    <div>
                        <span>Tailwind</span>
                        <span class="text-xs text-blue-300 block">CSS, V4.3</span>
                    </div>
                    <div>
                        <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
                    </div>
            ...
            <a href="https://laravel-livewire.com/" target="_blank" rel="noopener">
                <div
                    ...
                    <div>
                        <span>Livewire</span>
                        <span class="text-xs text-blue-300 block">V2.4</span>
                    </div>
                    <div>
                        <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
                    </div>
            ...
            <a href="https://github.com/turbolinks/turbolinks" target="_blank" rel="noopener">
                <div
                    ...
                    <div>
                        ...
                        <span class="text-xs text-blue-300 block">Ajax, V5.2</span>
                    </div>
                    <div>
                        <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
                    </div>
